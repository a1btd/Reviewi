	...
	if format_req == 'CSV':
		...
		with file as f:
			...
			for data in extracted_data:
				...
				try:
					rating_5 = json_data['ratings']['5 stelle']
				except:
					rating_5 = '0%'
				try:
					rating_4 = json_data['ratings']['4 stelle']
				except:
					rating_4 = '0%'
				try:
					rating_3 = json_data['ratings']['3 stelle']
				except:
					rating_3 = '0%'
				try:
					rating_2 = json_data['ratings']['2 stelle']
				except:
					rating_2 = '0%'
				try:
					rating_1 = json_data['ratings']['1 stella']
				except:
					rating_1 = '0%'
