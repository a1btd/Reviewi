...
webdomain = 'fr'
pre_author = ''
rating_rep = ' sur 5\u00a0\u00e9toiles'
rating_rep2 = ' sur 5 étoiles'
date_rep = 'le '
init_price_cut = 0
fin_price_cut = -2
currency = 'Euro'
	...
	if format_req == 'CSV':
		...
		with file as f:
			...
			for data in extracted_data:
				...
				try:
					rating_5 = json_data['ratings']['5 00e9toiles']
				except:
					rating_5 = '0%'
				try:
					rating_4 = json_data['ratings']['4 00e9toiles']
				except:
					rating_4 = '0%'
				try:
					rating_3 = json_data['ratings']['3 00e9toiles']
				except:
					rating_3 = '0%'
				try:
					rating_2 = json_data['ratings']['2 00e9toiles']
				except:
					rating_2 = '0%'
				try:
					rating_1 = json_data['ratings']['1 00e9toile']
				except:
					rating_1 = '0%'
